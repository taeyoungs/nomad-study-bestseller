const tokens = {
  ...
  "fonts.dancing": {
    "value": "var(--font-dancing-script), cursive",
  ...
  "shadows.float": {
    "value": "16px 16px 5px 0px rgba(236, 144, 107, 0.15)",
    "variable": "var(--shadows-float)"
  },
  "shadows.sinking": {
    "value": "7px 7px 5px 0px rgba(236, 144, 107, 0.75)",
    "variable": "var(--shadows-sinking)"
  },
  "breakpoints.sm": {
    "value": "640px",
